...
export HADOOP_CLASS9=$HADOOP_HOME/share/hadoop/tools/lib/*
export SPARK_CLASSPATH=$SPARK_CLASSPATH:$HADOOP_CLASS1:$HADOOP_CLASS2:$HADOOP_CLASS3:$HADOOP_CLASS4:$HADOOP_CLASS5:$HADOOP_CLASS6:$HADOOP_CLASS7:$HADOOP_CLASS8:$HADOOP_CLASS9
export SPARK_HISTORY_OPTS="-Dspark.history.ui.port=18080 -Dspark.history.retainedApplications=5 -Dspark.history.fs.logDirectory=hdfs://mycluster/sparkhistory/app"
